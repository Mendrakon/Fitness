...
export function BottomNav() {
  ...
  return (
    <nav className="bottom-nav fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-background/95 backdrop-blur-md" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
